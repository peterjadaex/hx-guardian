...
printf '{"rule":"os_privacy_setup_prompt_disable","action":"NOT_APPLICABLE","message":"Install /Library/Application Support/hxguardian/unified/com.hxguardian.unified.mobileconfig and approve in System Settings > General > Device Management."}\n'
exit 2
