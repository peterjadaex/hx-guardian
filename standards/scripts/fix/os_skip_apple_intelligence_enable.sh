...
printf '{"rule":"os_skip_apple_intelligence_enable","action":"NOT_APPLICABLE","message":"Install /Library/Application Support/hxguardian/unified/com.hxguardian.unified.mobileconfig and approve in System Settings > General > Device Management."}\n'
exit 2
