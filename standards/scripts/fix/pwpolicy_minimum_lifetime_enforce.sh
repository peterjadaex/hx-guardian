...
# Standards: cisv8
# Description: Set Minimum Password Lifetime to 24 Hours
# =============================================================================
...
if [[ $STATUS -eq 0 ]]; then
    printf '{"rule":"pwpolicy_minimum_lifetime_enforce","action":"EXECUTED","message":"Fix applied"}\n'
    exit 0
else
    printf '{"rule":"pwpolicy_minimum_lifetime_enforce","action":"FAILED","message":"pwpolicy returned non-zero"}\n'
    exit 1
fi
