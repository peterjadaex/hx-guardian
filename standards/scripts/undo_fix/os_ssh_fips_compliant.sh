#!/bin/zsh --no-rcs
# =============================================================================
# Rule:      os_ssh_fips_compliant (UNDO)
# Category:  Operating System
# Description: Remove the FIPS-restricted algorithm lines from 01-mscp-ssh.conf
#              and remove the /etc/ssh/crypto.conf symlink if pointing at fips.conf.
# =============================================================================
...
printf '{"rule":"os_ssh_fips_compliant","action":"UNDONE","message":"Undo applied"}\n'
exit 0
