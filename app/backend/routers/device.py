...
from core.models import DeviceSnapshot
...
async def collect_connections() -> dict:
    ...
    try:
        ...
        for entry in bt_data.get("SPBluetoothDataType", []):
            ...
            bt_enabled = controller.get("controller_bluetoothEnabled", "").lower() == "attrib_yes"
...
async def get_device_connections(_: str = Depends(verify_token)):
    return await collect_connections()
